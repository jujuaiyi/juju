package com.harmony.entity.constants;
...
public class Constants {
    ...
    public static final String REDIS_KEY_DOWNLOAD = "harmony:download:";

    public static final String REDIS_KEY_SYS_SETTING = "harmony:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "harmony:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "harmony:user:file:temp:";
